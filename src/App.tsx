...
export default function App() {
  ...
  const [requests, setRequests] = useState<ClientRequest[]>(SEED_REQUESTS);
  const [caseDocs, setCaseDocs] = useState<Record<string, CaseFileItem[]>>({});
